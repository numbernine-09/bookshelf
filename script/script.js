...
document.addEventListener("DOMContentLoaded", function () {
  const buttonBelumSelesai = document.getElementById(
    "submitBelumSelesaiDibaca"
  );
...
document.addEventListener(RENDER_EVENT, function () {
  ...
  const bukuBelumSelesaiDibaca = document.getElementById(
    "daftarBukuBelumSelesaiDibaca"
  );
